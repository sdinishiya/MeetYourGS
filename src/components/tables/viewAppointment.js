...
const rows = [
  ...
  createData('V002', 'Hirusha Chamod', '16.07.2021', '11.00', '0772345678', 'hirusha@gmail.com'),
  createData('V003', 'Dineshiya Sudharshan', '18.07.2021', '12.30', '0773456789', 'dineshiya@gmail.com'),
  createData('V004', 'Lishani Suriyampola', '19.07.2021', '13.00', '0774567890', 'lishani@gmail.com'),
        ...
        <TableBody>
          {rows.map((row) => (
            <TableRow key={row.name}>
              ...
              <TableCell align="center"><Button variant="contained" color="primary">Accept</Button></TableCell>
              <TableCell align="center"><Button variant="contained" color="secondary">Decline</Button></TableCell>
